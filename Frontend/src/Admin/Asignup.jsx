...
const Asignup = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center mt-28 bg-white"> 
      ...
      <div>
      <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4Ap4TeSE_0CSO85y6WeSpilz7d3K4mtLzGQIyoiRZeQ&s'  style={{marginRight:"35px",height:"380px",width:"270px"}} />
      </div>
